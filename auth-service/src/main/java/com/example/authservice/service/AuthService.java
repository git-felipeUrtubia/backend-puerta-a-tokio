...
public class AuthService {
    ...
    public String RegisterUser(RegisterRequestDTO req) throws RoleNotFoundException {
        ...
        return restTemplate.postForObject("http://user-service.railway.internal:8080/user/save-user", userProfileRequest, String.class);
...
//        return "Usuario guardado exitosamente";
    ...
    public AuthResponseDTO LoginUser(LoginRequestDTO req) {
        ...
        RestTemplate restTemplate = new RestTemplate();
        String url = "http://user-service.railway.internal:8080/user/find-user-{id}";
